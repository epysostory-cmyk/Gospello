...
export default function ShareButton({
  ...
  const iconBtn = 'w-9 h-9 rounded-full flex items-center justify-center transition-all duration-150 hover:scale-110 hover:shadow-md select-none'

  if (compact) {
    return (
      <div className="flex items-center gap-2">
        <a href={waHref} target="_blank" rel="noopener noreferrer"
          className={iconBtn} style={{ backgroundColor: '#25D366' }} title="Share on WhatsApp">
        ...
        <a href={tgHref} target="_blank" rel="noopener noreferrer"
          className={iconBtn} style={{ backgroundColor: '#229ED9' }} title="Share on Telegram">
          <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white">
        ...
        <a href={xHref} target="_blank" rel="noopener noreferrer"
          className={`${iconBtn} bg-black`} title="Share on X">
          <svg viewBox="0 0 24 24" className="w-4 h-4 fill-white">
        ...
        <button onClick={copyLink}
          className={iconBtn}
          style={{ backgroundColor: copied ? '#ECFDF5' : '#F3F4F6' }}
          title="Copy link">
          {copied ? (
            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="#059669" strokeWidth="2.5">
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7"/>
            </svg>
          ) : (
            <svg viewBox="0 0 24 24" className="w-4 h-4" fill="none" stroke="#6B7280" strokeWidth="2">
