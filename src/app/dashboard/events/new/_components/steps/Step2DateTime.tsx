...
import type { DaySchedule, EventSession, RecurrenceRule } from '@/types/database'
...
export default function Step2DateTime({ formData, updateForm, errors }: StepProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      {eventType === 'single' && (
        <RecurringSection
          rule={formData.recurrence_rule ?? null}
          startDate={formData.start_date}
          onChange={(rule: RecurrenceRule | null) => updateForm('recurrence_rule', rule)}
        />
      )}
