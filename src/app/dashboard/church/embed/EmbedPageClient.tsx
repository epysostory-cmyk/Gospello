...
export default function EmbedPageClient({ embedUrl, iframeCode, churchName }: Props) {
    ...
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 mb-3">
          One snippet. Paste it into any page on your website — WordPress, Wix, Squarespace, anything.
        </p>
      ...
      <div>
        ...
        <div className={`mx-auto transition-all duration-300 ${previewSize === 'mobile' ? 'max-w-[375px]' : 'max-w-full'}`}>
          <iframe
            ...
            title={`${churchName} — Upcoming Events`}
          />
        </div>
      </div>
