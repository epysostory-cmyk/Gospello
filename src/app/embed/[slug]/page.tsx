        ...
        <div className="wrap">
          ...
          <div className="header">
            {church.logo_url ? (
              ...
              <img src={church.logo_url} alt={church.name} className="header-logo" />
            ) : (
              <div className="header-logo-fallback">{church.name[0]?.toUpperCase()}</div>
            )}
            <div>
              <div className="header-name">{church.name}</div>
          ...
          <div className="footer">
            <span />
            <a
              href={`${siteUrl}/churches/${church.slug}`}
              target="_blank"
              rel="noopener noreferrer"
